<nav class="navbar navbar-expand-md px-md-5">
  <a class="navbar-brand" href="<?php echo SROOT."/public/index.php"; ?>"><img src="<?php echo SROOT."/public/media/images/logo/vinpear.jpeg";?>" class="d-inline-block align-top" style="max-height:100px;"></img></a>
  <button
