...
<head>
  ...
  <link rel="shortcut icon" href="https://vinpearl.com/themes/porto/images/logos/logo_vp_footer.svg" type="image/png"/>
...
<body class="admin">
  <header id="admin-header">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="<?php echo SROOT . "/admin/index.php"; ?>"><img src="<?php echo SROOT . "/public/media/images/logo/vinpear.jpeg"; ?>" class="d-inline-block align-top" height="90px"></img></a>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              <span class="dropdown-item">Signed in as <b>admin</b></span>
          </li>
        </ul>
